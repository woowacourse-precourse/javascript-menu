...
const GAME_MESSAGE = Object.freeze({
  ...
  result: '메뉴 추천 결과입니다.',
  days: `구분${GAME_STRING.dividingLine}월요일${GAME_STRING.dividingLine}화요일${GAME_STRING.dividingLine}수요일${GAME_STRING.dividingLine}목요일${GAME_STRING.dividingLine}금요일`,
  finish: '추천을 완료했습니다.',
  category: '카테고리',
});
